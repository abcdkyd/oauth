<template>
    <div class="wrapper">
        <div class="header">Login to Oauth</div>
        <div class="form">
            <ul>
                <li>
                    <div class="text">
                        <span class="yonghu"></span><input type="text" v-model="form.username">
                    </div>
                </li>
                <li>
                    <div class="password">
                        <span class="mima"></span><input type="password" v-model="form.password">
                    </div>
                </li>
                <li>
...
<script>
    export default {
        ...
        methods: {
            login() {
                axios.post('/api/user/token', this.form).then(response => {
